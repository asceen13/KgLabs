...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        graphicsView->setGeometry(QRect(0, 0, 1251, 711));
        CenterX = new QDoubleSpinBox(centralwidget);
        CenterX->setObjectName(QString::fromUtf8("CenterX"));
        CenterX->setGeometry(QRect(1260, 300, 62, 23));
        CenterY = new QDoubleSpinBox(centralwidget);
        CenterY->setObjectName(QString::fromUtf8("CenterY"));
        CenterY->setGeometry(QRect(1340, 300, 62, 23));
        label = new QLabel(centralwidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(1280, 280, 58, 15));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(1350, 280, 58, 15));
        label_3 = new QLabel(centralwidget);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(1290, 260, 58, 15));
